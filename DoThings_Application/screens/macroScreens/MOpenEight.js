...
const image = require("./img/8.png")

export default class MOpenEight extends React.Component {
            ...
            <View style={{flex:1}}>
              <ImageBackground source={image} style={{flex: 1}}>
                ...
                <TouchableOpacity backgroundColor="green" 
                                  style={{flex:1, backgroundColor:"rgba(255,0,0,0.3)", height:30, width:100,
                                  position:"absolute", bottom:25, right:15, zIndex:100}} 
                                  type="outline" title="Go to Second Demo" 
                                  onPress={() => this.navigation.navigate("MOpenNine")} />
