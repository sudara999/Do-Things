...
export default function TransitionToHelper({ navigation }) {
    return (
        <View style={{ alignItems: "center", justifyContent: "space-between", flex: 1 }}>
            ...
            <Button color="green" type="outline" title="Go to First Demo" onPress={() => navigation.navigate("CallScreen")} />
            <Button color="green" type="outline" title="Go to Second Demo" onPress={() => navigation.navigate("MHomeScreen")} />
