...
export default function TransitionToHelper({ navigation }) {
    return (
        <View style={{ alignItems: "center", justifyContent: "space-between", flex: 1 }}>
            ...
            <Button type="outline" title="Show Helper Screen" onPress={() => navigation.navigate("CallScreen")} />
            <Button type="clear" title="Press this button to go back to the contacts page" onPress={() => navigation.navigate("ContactsScreen")} />
        </View>
    );
}